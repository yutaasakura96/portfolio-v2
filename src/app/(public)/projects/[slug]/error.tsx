...
export default function ProjectError({ reset }: { reset: () => void }) {
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 sm:px-6 py-24 text-center">
      <h1 className="text-2xl font-bold text-foreground">{ui("errorLoadingProject", locale)}</h1>
      <p className="mt-4 text-muted-foreground">{ui("errorProjectDescription", locale)}</p>
