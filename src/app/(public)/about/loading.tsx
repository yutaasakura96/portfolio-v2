  ...
  return (
    <div className="mx-auto max-w-5xl px-4 sm:px-6 py-12">
      ...
      <div className="mb-12">
        ...
        <div className="h-6 w-96 bg-muted/60 rounded animate-pulse" />
      </div>
      ...
      <div className="mb-16 grid grid-cols-1 md:grid-cols-[260px_1fr] gap-12 md:gap-16">
        ...
        <div className="flex flex-col items-center text-center">
          <div className="w-44 h-44 rounded-full bg-muted animate-pulse mb-6" />
          <div className="h-5 w-32 bg-muted rounded animate-pulse mb-2" />
          <div className="h-4 w-24 bg-muted/60 rounded animate-pulse mb-1" />
          <div className="h-4 w-28 bg-muted/60 rounded animate-pulse mb-5" />
      ...
      <section className="mb-16">
        ...
        <div className="flex gap-1 border-b border-border mb-6">
          {[80, 96, 72, 88].map((w, i) => (
            <div key={i} className="h-9 bg-muted/60 rounded-t animate-pulse" style={{ width: w }} />
          ))}
        </div>
        {/* Icon cards grid */}
        <div className="grid grid-cols-3 gap-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-6">
          {Array.from({ length: 12 }).map((_, i) => (
            <div
              key={i}
              className="flex flex-col items-center justify-center gap-2 rounded-xl border border-border bg-card p-3"
            >
      ...
      {/* Experience section */}
      <section className="mb-16">
        <div className="h-8 w-28 bg-muted rounded animate-pulse mb-6" />
        <div className="space-y-0">
          {[1, 2, 3].map((i, index) => (
            <div key={i} className="relative pl-8 pb-8 last:pb-0">
              {/* Timeline line */}
              {index < 2 && <div className="absolute left-[11px] top-3 bottom-0 w-px bg-border" />}
              {/* Timeline dot */}
              <div className="absolute left-0 top-1.5 h-[22px] w-[22px] rounded-full border-2 border-border bg-card animate-pulse" />
              <div className="rounded-xl border border-border bg-card p-5">
                <div className="flex items-start gap-4">
                  <div className="h-10 w-10 shrink-0 bg-muted/60 rounded-lg animate-pulse" />
                  <div className="flex-1 space-y-2">
                    <div className="h-6 w-48 bg-muted rounded animate-pulse" />
                    <div className="h-4 w-32 bg-muted/60 rounded animate-pulse" />
                    <div className="h-4 w-40 bg-muted/60 rounded animate-pulse" />
                    <div className="h-16 w-full bg-muted/40 rounded animate-pulse mt-3" />
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="mb-16">
        ...
        <div className="space-y-4">
          {[1, 2].map((i) => (
            ...
            >
              <div className="shrink-0 h-10 w-10 rounded-lg bg-muted/60 animate-pulse" />
              <div className="flex-1 space-y-2">
                <div className="h-6 w-48 bg-muted rounded animate-pulse" />
